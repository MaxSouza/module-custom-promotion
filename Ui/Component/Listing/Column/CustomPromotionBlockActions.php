...
namespace MaxSouza\CustomPromotion\Ui\Component\Listing\Column;
...
class CustomPromotionBlockActions extends Column
{
    private const ENTITY_NAME = 'Custom promotion';

    private const EDIT_URL_PATH = 'custom_promotion/custompromotion/edit';
    private const DELETE_URL_PATH = 'custom_promotion/custompromotion/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[CustomPromotionInterface::CUSTOM_PROMOTION_ID])) {
                    $entityName = self::ENTITY_NAME;
                    $urlData = [
                            CustomPromotionInterface::CUSTOM_PROMOTION_ID =>
                            $item[CustomPromotionInterface::CUSTOM_PROMOTION_ID]
                    ];
